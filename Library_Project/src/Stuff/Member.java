...
public class Member extends Person {
    ...
    // Our implementation cannot avoid to delete items with the same name.
    public void returnItem(LibraryCollection item) {
        if (materials.containsKey(item.title.hashCode()) == false) {
            System.out.println("The member has not borrowed this item.");
            return;
        }

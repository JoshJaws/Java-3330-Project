...
public class ProjectMain {
    ...
    public static void mainMenu() {
        ...
        System.out.println("8. Check materials");
    ...
    public static void newMemberEvent(Library library) {
        ...
        while (true) {
            System.out.print("Enter Membership type (Student-S/Professor--P/External--E): ");
    ...
    public static void newEmployeeEvent(Library library) {
        ...
        while (true) {
            System.out.print("Enter Employee type (Librarian--L/Technician--T): ");
            memtype = scn.nextLine();
    ...
    public static void newCheckMaterials(Library library) {
        System.out.println("");
        System.out.println("*****************************");
        ...
        System.out.println("Science section:");
        for (LibraryCollection item : library.scienceSection.values()) {
        ...
        for (LibraryCollection item : library.newspaperSection.values()) {
            System.out.println(item.title);
            System.out.println("Price: " + item.price);
            System.out.println(" ");
        }
        ...
        for (LibraryCollection item : library.lawSection.values()) {
            System.out.println(item.title);
            System.out.println("Price: " + item.price);
            System.out.println(" ");
        }
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    ProjectMain.newCheckMaterials(library);
                    break;
                case 9:
                    scanner.close();
                    System.exit(0);
